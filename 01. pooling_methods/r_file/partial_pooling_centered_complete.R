...
stan_file_path <- "/Users/chengu/Documents/master thesis/final_final_final_code/stan_file_for_pooling_method/partial_pooling_centered_complete_0703.stan"
...
rds_data_output_file <- file.path(rds_output_dir, "stan_data_partial_centered.rds")
rds_fit_output_file <- file.path(rds_output_dir, "stan_fit_partial_centered.rds")
